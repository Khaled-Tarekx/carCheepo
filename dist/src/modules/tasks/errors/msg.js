...
const AssigneeNotFound = `task must be assigned to a user first before` + ` marking it as completed`;
...
export { TaskNotFound, AssigneeOrCreatorNotFound, TaskCreationFailed, TaskUpdatingFailed, TaskDeletionFailed, MailFailedToSend, AssigneeNotFound, CompleteSubTasksFirst, TaskAlreadyMarked, };
