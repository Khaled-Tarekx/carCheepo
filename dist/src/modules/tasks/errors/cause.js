...
class AssigneeNotFound extends Error {
    constructor() {
        super(`task must be assigned to a workspace member/members first before` +
            ` marking it as completed`);
        this.name = 'AssigneeNotFound';
    }
}
export { TaskNotFound, TaskUpdatingFailed, TaskDeletionFailed, TaskCreationFailed, MailFailedToSend, TaskMarkedCompleted, CompleteSubTasksFirst, AssigneeNotFound, };
