...
import { getUsers, getUser, deleteUser, updateUserInfo, getUserReplies, getUserReply, getUserComment, getUserComments, getUserTasks, getUserTask, } from './controllers.js';
...
router.put('/update-user', validateResource({ bodySchema: updateUserSchema }), updateUserInfo);
router.patch('/change-password', validateResource({ bodySchema: changePasswordSchema }), changePassword);
