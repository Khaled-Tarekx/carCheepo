...
const carTypesEnum = ['Sedan', 'SUV', 'Convertible', 'Hatchback'] as const;
const transmissionTypesEnum = ['Manual', 'Automatic', 'Semi-Automatic', 'IMT'] as const;
const capacityTypesEnum = ['2 People', '4 People', '7 People'] as const;
const fuelTypesEnum = ['electric', 'diesel', 'hybrid', 'petrol', 'GAS', 'hydrogen'] as const;
const statusEnum = ['sold', 'pending', 'available'] as const;
const userStatusEnum = ['confirmed', 'pending', 'cancelled'] as const;
